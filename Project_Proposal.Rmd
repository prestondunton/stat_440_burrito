...
Let $\sigma=1.5$, and $\sigma^{2}=2.25$, this means that $a/b=2.25$.  Let $a/b^2=1$,
this means that $a=2.25^2=5.0625$ and $b=2.25$

$\mathbf{\beta}\sim MVN(\overrightarrow{0},\tau^2\textbf{I})$

Let $\tau=2$ so that $\tau^2=4$
